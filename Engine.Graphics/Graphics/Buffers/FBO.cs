...
public unsafe class FBO : BufferBase, IResizeable
{
    ...
    {
        RenderPass renderPass = VoxelEngine.Instance.Renderer.FramebufferClearRenderPass.RenderPass;
        ...
        var depthFormat = VoxelEngine.Instance.Renderer.VulkanDepthBuffer.FindDepthFormat();
    ...
    public void Bind(CommandBuffer commandBuffer)
    {
        ...
        var renderer = VoxelEngine.Instance.Renderer;
        if (!_started)
        {
            _started = true;
    ...
    public void Unbind()
    {
        ...
        {
            SType = StructureType.RenderPassBeginInfo,
            RenderPass = renderer.ClearRenderPass.RenderPass,
