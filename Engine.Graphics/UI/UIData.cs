...
namespace PBG.UI
{
    public class UIData
    {
        ...
        {   
            ...
            { 
                VertexShaderPath = Path.Combine(VoxelEngine.ShaderPath, "ui/ui.vert"), 
                FragmentShaderPath = Path.Combine(VoxelEngine.ShaderPath, "ui/ui.frag") 
            };
            ...
            { 
                VertexShaderPath = Path.Combine(VoxelEngine.ShaderPath, "text/text.vert"), 
                FragmentShaderPath = Path.Combine(VoxelEngine.ShaderPath, "text/text.frag")
            };
