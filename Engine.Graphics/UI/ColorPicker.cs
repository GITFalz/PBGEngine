...
public class ColorPicker
{
    ...
    */
    ...
    public ColorPicker(int width, int height, Vector2i position)
    {
        ...
        Vector2i newPosition = ((int)_colorPickerPosition.X, (int)-_colorPickerPosition.Y + (VoxelEngine.Height - Height));
    ...
    [
        ...
        .OnHold(_ => SetSliderColor(Input.GetMousePosition().X - Picker.ColorPickerPosition.X, Input.GetMousePosition().Y - (VoxelEngine.Height - Picker.ColorPickerPosition.Y) + Picker.Height))[
    ...
    {
        /*
        GL.Viewport(0, 0, VoxelEngine.Width, VoxelEngine.Height);
