...
public class FileManagerUI : UIScript
{
    ...
    public string DefaultPath = VoxelEngine.MainPath;
    ...
    private static readonly Section[] _knownDirectories =
    {
        (
            "PROJECT FOLDERS",
            [
                (Path.Combine(VoxelEngine.MainPath, "custom", "models"), 31),
                (Path.Combine(VoxelEngine.MainPath, "custom", "textures"), 21),
                (Path.Combine(VoxelEngine.MainPath, "custom", "animations"), 32),
                (Path.Combine(VoxelEngine.MainPath, "custom", "nodes"), 34),
                (Path.Combine(VoxelEngine.MainPath, "custom", "groups"), 35),
                (Path.Combine(VoxelEngine.MainPath, "custom", "audio"), 33)
            ]
        ),
        (
            "SYSTEM",
