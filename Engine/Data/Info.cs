...
public class Info : ScriptingNode
{
    ...
    private class InfoUI : UIScript
    {
        ...
        new UIVCol(top_[5], left_[5])[
            new UIVCol(spacing_[5])[
                new UIText("--General--", mc_[11], fs_[1]),
                new UIText("Fps: 9999", mc_[11], fs_[1]).Ref(ref FpsText),
                //new UIText($"GPU: {GL.GetString(StringName.Renderer)}", mc_[100], fs_[1]).Ref(ref GPUText),
                new UIText("0", mc_[15], fs_[1]).Ref(ref RamUsageText),
                new UIText("--Chunks--", mc_[11], fs_[1]),
                new UIText("0", mc_[50], fs_[1]).Ref(ref RenderedChunks),
                ...
                new UIText("--VRam--", mc_[8], fs_[1]),
                new UIText("0", mc_[100], fs_[1]).Ref(ref VramTotalText),
                new UIText("0", mc_[100], fs_[1]).Ref(ref VramFreeText),
                new UIText("0", mc_[100], fs_[1]).Ref(ref VramUsedText),
                new UIText("0%", mc_[100], fs_[1]).Ref(ref VramPrecentText),
                new UIText("--Player--", mc_[8], fs_[1]),
                new UIText("x y z:  0  0  0", mc_[100], fs_[1]) .Ref(ref PositionText)
            ]
        ];
    }
