...
{
    private Silk.NET.Vulkan.Buffer[] _uniformBuffers = new Silk.NET.Vulkan.Buffer[GFX.MAX_FRAMES_IN_FLIGHT];
    private DeviceMemory[] _uniformBuffersMemory = new DeviceMemory[GFX.MAX_FRAMES_IN_FLIGHT];
    private void*[] _uniformBuffersMapped = new void*[GFX.MAX_FRAMES_IN_FLIGHT];
    ...
    {
        var bufferPtr = (byte*)_uniformBuffersMapped[GFX.MAX_FRAMES_IN_FLIGHT + GFX.CurrentFrame];
        var dest = bufferPtr;
        *(T*)dest = data;
    }
