...
public struct StyleArray(params IStyleData[] styles) : IStyleData
{
    public readonly void Set(UIElementBase element)
    {
        for (int i = 0; i < styles.Length; i++)
            styles[i].Set(element);
    }
}
...
public struct UnaryStyle<T> : IStyleData
{
    ...
    public readonly void Set(UIElementBase element) => _action.Invoke(_v, element);
...
public struct BinaryStyle<T1, T2> : IStyleData
{
    ...
    public readonly void Set(UIElementBase element) => _action.Invoke(_v1, _v2, element);
...
public struct TrinaryStyle<T1, T2, T3> : IStyleData
{
    ...
    public readonly void Set(UIElementBase element) => _action.Invoke(_v1, _v2, _v3, element);
...
public struct QuaternaryStyle<T1, T2, T3, T4> : IStyleData
{
    ...
    public readonly void Set(UIElementBase element) => _action.Invoke(_v1, _v2, _v3, _v4, element);
