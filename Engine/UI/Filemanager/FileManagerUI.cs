...
public class FileManagerUI : UIScript
{
    ...
    new UICol(w_[800], h_[640], top_left)
    .OnHoverEnter(_ => Manager.IsHovering = true)
    .OnHoverExit(_ => Manager.IsHovering = false)[
        new UICol(w_full, h_[40], blank_full_g_[25], border_ui_[2, 2, 2, 0], border_color_g_[30]).OnHold(Move)[
            new UIImg(w_[30], h_[30], middle_left, left_[10], icon_[14], gray_[50], top_[1]),
            new UIText("File Manager", mc_[12], fs_[1.3f], middle_left, left_[45], top_[1]),
            new UICol(w_[25], h_[25], border_ui_[2, 2, 2, 2], border_color_g_[30], blank_full, middle_right, right_[12], top_[1], hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)
            .OnClick(_ => Manager.ToggleOff())
            .OnHoverEnter(HoverEnterIconButton)
            .OnHoverExit(HoverExitIconButton)[
                new UIImg(icon_[15], w_[20], h_[20], gray_[50], middle_center)
            ]
        ],
        new UIVCol(w_full, h_full_minus_[40], bottom_center, blank_full_g_[20], border_ui_[2, 0, 2, 2], border_color_g_[30])[
            new UICol(w_full, h_[40], border_ui_[0, 2, 0, 2], border_color_g_[30])[
                new UIText("PATH:", mc_[5], fs_[1f], middle_left, left_[12], gray_[50]),
                new UIHScroll(w_full_minus_[110], middle_right, right_[42], h_[25], border_ui_[2, 2, 2, 2], border_color_g_[30], blank_full_g_[10], mask_children)[
                    new UIField(DefaultPath, mc_[1000], fs_[1f], middle_left, left_[5])
                    .OnTextEnter(f =>
                    {
                ...
                new UICol(w_[25], h_[25], border_ui_[2, 2, 2, 2], border_color_g_[30], rgba_[0.3f, 0.3f, 0.3f, 0f], blank_full, middle_right, right_[12], hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)
                .OnClick(_ =>
                {
                ...
                .OnHoverExit(c => { if (_filesAsList) HoverExitIconButton(c); })[
                    new UIImg(icon_[39], w_[20], h_[20], gray_[50], middle_center)
                ]
            ],
            new UIHCol(w_full_minus_[4], top_center, h_full_minus_[80])[
                new UIVScroll(w_[150], h_full, border_ui_[0, 0, 2, 0], border_color_g_[30], mask_children, border_[5, 5, 5, 5])[
                    Foreach(_knownDirectories, section =>
                        new UIVCol(w_full, grow_children, ignore_invisible)[
                            new UICol(w_full, h_[20])[
                                new UIText(section.Name, mc_[section.Name.Length], fs_[1f], gray_[50], left_[5], middle_left)
                            ],
                            new UIVCol(w_full, h_[section.Paths.Length * 26], spacing_[1])[
                                Foreach(section.Paths, data =>
                                    new UICol(w_full, h_[25], blank_full, hover_translation_[(-10, 0)], hover_translation_duration_[0.2f], hover_translation_easeout)
                                    ...
                                    .OnClick(_ => GenerateFiles(data.Path))[Run(() => {
                                        ...
                                        return [
                                            new UICol(w_full, h_full, hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)[
                                                new UIImg(h_[22], w_[22], left_[7], middle_left, icon_[data.Icon], slice_null, rgb_[0.45f, 0.60f, 0.75f])
                                            ],
                                            new UIText(fileName, mc_[fileName.Length], fs_[1.2f], middle_left, left_[40])
                                        ];
                                    })]
                                )
                            ]
                ...
                new UIVCol(w_full_minus_[150], h_full)[
                    new UICol(w_full, h_[40], border_ui_[0, 0, 0, 2], border_color_g_[30])[
                        new UICol(w_[25], h_[25], border_ui_[2, 2, 2, 2], bottom_[1], border_color_g_[!_filesAsList ? 40 : 30], rgba_[0.3f, 0.3f, 0.3f, !_filesAsList ? 1f : 0f], blank_full, middle_right, right_[40], hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)
                        .OnClick(_ =>
                        {
                            _filesAsList = false;
                        ...
                        .OnHoverEnter(HoverEnterIconButton)
                        .OnHoverExit(c => { if (_filesAsList) HoverExitIconButton(c); })[
                            new UIImg(icon_[38], w_[20], h_[20], gray_[!_filesAsList ? 70 : 50], middle_center)
                        ].Ref(ref _gridButton),
                        new UICol(w_[25], h_[25], border_ui_[2, 2, 2, 2], bottom_[1], border_color_g_[_filesAsList ? 40 : 30], rgba_[0.3f, 0.3f, 0.3f, _filesAsList ? 1f : 0f], blank_full, middle_right, right_[10], hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)
                        .OnClick(_ =>
                        {
                            _filesAsList = true;
                        ...
                        .OnHoverEnter(HoverEnterIconButton)
                        .OnHoverExit(c => { if (!_filesAsList) HoverExitIconButton(c); })[
                            new UIImg(icon_[14], w_[20], h_[20], gray_[!_filesAsList ? 70 : 50], middle_center)
                        ].Ref(ref _listButton)
                    ],
                    new UIVScroll(w_full, h_full_minus_[40], mask_children, border_[0, 5, 0, 5], spacing_[5]).Ref(ref _folders)
                ]
            ],
            new UICol(w_full_minus_[4], top_center, h_[40], border_ui_[0, 2, 0, 0], border_color_g_[30])[
                new UIText($"{CurrentPaths.Count} ITEMS", mc_[15], fs_[1f], middle_left, left_[12]).Ref(ref _elementCountText),
                new UIText($"FILE NAME", mc_[9], fs_[1f], middle_right, right_[340]),
                new UICol(w_full, h_full)[
                    new UIHScroll(w_[300], middle_right, right_[35], h_[25], border_ui_[2, 2, 2, 2], border_color_g_[30], blank_full_g_[10], mask_children)[
                        new UIField("name", mc_[100], fs_[1f], middle_left, left_[5]).Ref(ref _fileNameField)
                    ],
                    new UICol(w_[25], h_[25], border_ui_[2, 2, 2, 2], border_color_g_[30], blank_full, middle_right, right_[5], hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)
                    .OnClick(_ => {
                    ...
                    .OnHoverEnter(HoverEnterIconButton)
                    .OnHoverExit(HoverExitIconButton)[
                        new UIImg(icon_[42], w_[20], h_[20], gray_[50], middle_center)
                    ]
    ...
    public void GenerateFiles()
    {
        ...
        if (!_filesAsList)
        {
            ...
            {
                UIHCol collection = new(w_full_minus_[5], top_center, h_[70], border_[2.5f, 0, 0, 0], spacing_[5]);
                ...
                for (int x = 0; x < hCount; x++)
                {
                    ...
                    var element = new UICol(w_minus_[100f / (float)hCount, 5], h_[70], data_["path", CurrentPaths[current]], blank_sharp)
                    ...
                    .OnHoverExit(c => { if (!_selectedButtons.Contains(c)) c.UpdateColor((0f, 0f, 0f, 0f)); })[
                        new UICol(w_full, h_full, hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)[
                            new UIImg(w_[40], h_[40], top_center, top_[5], icon_[icon], bg_white)
                        ],
                        new UIText(file, mc_[Mathf.Min(17, file.Length)], fs_[1f], bottom_center, bottom_[15]),
                        If(file.Length > 17, () => {
                            string next = file.Substring(17, Mathf.Min(17, file.Length - 17));
                            return new UIText(next, mc_[next.Length], fs_[1f], bottom_center, bottom_[5]);
                        })
                    ];
        ...
        else
        {
            ...
            for (int i = 0; i < elementCount; i++)
            {
                ...
                collections[i] = new UICol(w_full_minus_[10], top_center, h_[30], blank_sharp)
                .OnClick(i < directoryCount ? ViewFolder : ClickFile)
                .OnHoverEnter(c => c.UpdateColor((0.3f, 0.3f, 0.3f, 1f)))
                .OnHoverExit(c => { if (!_selectedButtons.Contains(c)) c.UpdateColor((0f, 0f, 0f, 0f)); })[
                    new UICol(w_full, h_full, hover_scale_[1.2f], hover_scale_duration_[0.25f], hover_scale_easeout)[
                        new UIImg(middle_left, left_[5], icon_[icon], h_[25], w_[25], bg_white)
                    ],
                    new UIText(file, mc_[Mathf.Min(83, file.Length)], fs_[1f], middle_left, left_[40])
                ];
            }
        }
