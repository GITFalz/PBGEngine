...
{
    public class FloatNode(GetterValue[] getters, SetterValue[] setters, string type) : NoiseNode(getters, setters, type)
    {
        ...
        public void Function() {}//Output.SetValue(Input.F());
