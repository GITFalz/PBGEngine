...
{
    public class IntNode(GetterValue[] getters, SetterValue[] setters, string type) : NoiseNode(getters, setters, type)
    {
        ...
        public void Function() {} // Setters[0].SetValue(Getters[0].I());
