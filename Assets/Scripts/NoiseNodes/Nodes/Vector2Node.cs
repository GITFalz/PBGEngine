...
{
    public class Vector2Node(GetterValue[] getters, SetterValue[] setters, string type) : NoiseNode(getters, setters, type)
    {
        ...
        public void Function(){}// => Output.SetValue(Input.V2());
