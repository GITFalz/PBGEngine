...
public class TransformGizmo : Gizmo
{
    ...
    public Vector2 SliderDirection(Axis axis)
    {
        ...
        var origin  = Mathf.WorldToScreen(Position, proj, view, VoxelEngine.Width, VoxelEngine.Height) ?? (0, 0);
        var tip     = Mathf.WorldToScreen(Position + worldAxis, proj, view, VoxelEngine.Width, VoxelEngine.Height) ?? (0, 0);
