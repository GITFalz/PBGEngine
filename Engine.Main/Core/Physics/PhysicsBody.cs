...
namespace PBG.Physics
{
    public class PhysicsBody
    {
        ...
        public PhysicsBody(IVoxelRenderer voxelRenderer)
        {
        ...
        void Update()
        {
            ...
            lock (stateLock)
            {
                Position = Mathf.Lerp(previousPhysicsState.Position, currentPhysicsState.Position, (float)GameTime.PhysicsInterpolationT);
            }       
        }
        ...
        public void CollisionCheck()
        {
            ...
            for (int x = min.X; x <= max.X; x++)
            {
                for (int y = min.Y; y <= max.Y; y++)
                {
                    ...
                    {
                        if (VoxelRenderer.GetBlock((x, y, z), out var block) && !block.Value.IsAir())
