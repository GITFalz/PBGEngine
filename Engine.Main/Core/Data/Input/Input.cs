    ...
    public static class Input
    {
        ...
        public static void Start(IMouse mouse)
        {
            ...
            mouse.MouseMove += (mouse, position) =>
            {
                ...
                if (_oldCursorMode != CursorMode.Disabled || VoxelEngine.Instance.CursorMode != CursorMode.Normal)
                {
        ...
        public static void Update()
        {
            ...
            if (VoxelEngine.Instance.CursorMode != CursorMode.Disabled)
            ...
            _oldCursorMode = VoxelEngine.Instance.CursorMode;
        }
