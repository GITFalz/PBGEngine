...
namespace PBG.Voxel
{
    ...
    {
        public static string CoreBlockDataPath = FileManager.CreatePath(VoxelEngine.MainPath, "data", "core", "blocks");
        public static string BlockTexturesPath = FileManager.CreatePath(VoxelEngine.TexturePath, "blocks");
        ...
        public static void LoadBlocks()
        {
            ...
            var registryPath = VoxelEngine.CoreDataPath / "registry" / "block_registry.json";
            ...
            var palettePath = VoxelEngine.CoreDataPath / "palette" / "block_palette.json";
