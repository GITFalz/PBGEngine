...
public static class ItemDataManager
{
    ...
    public static void GenerateIcons()
    {
        ...
        */
        ...
        _textureArrayWrite ??= new ComputeShader(new() { ComputeShaderPath = VoxelEngine.ShaderPath / "computeShaders/textureArrayWrite.comp"});
        ...
        BlocksShader = new Shader(new(VoxelEngine.ShaderPath / "voxel" / "base.vert", VoxelEngine.ShaderPath / "voxel" / "base.frag"));
